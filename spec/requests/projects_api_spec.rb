...
describe "projects api", type: :request do
  ...
  context "create" do 
    describe "valid project" do
      before do
        post '/api/v1/projects', params: project_params(SAMPLE_PROJECT_NUM + 1)
      end
      ...
      it "creates a project" do
        expect(Project.all.size).to eq SAMPLE_PROJECT_NUM + 1
      end
    ...
    describe "invalid project" do
      ...
      it "does not create a project" do
        expect(Project.all.size).to eq SAMPLE_PROJECT_NUM
      end
  ...
  context "update" do   
    describe "existing project with valid params" do
      before do
        put '/api/v1/projects/1', params: { body: 'this is an updated body' }
      end
    ...
    describe "existing project with invalid params" do
      before do
        put '/api/v1/projects/1', params: { body: '' }
      end
